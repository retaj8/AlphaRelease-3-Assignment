...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($project->isProjectExists($projectId, $projectName)) {
        ...
        $message = $result ? "✅ تم إضافة المشروع بنجاح!" : "❌ حدث خطأ أثناء إضافة المشروع.";
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="card p-4">
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="team_leader" class="form-control" placeholder="أدخل مدير الفريق">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <?php foreach ($students as $student): ?>
                            <input class="form-check-input" type="checkbox" name="team_members[]" value="<?php echo $student; ?>" id="member-<?php echo $student; ?>">
