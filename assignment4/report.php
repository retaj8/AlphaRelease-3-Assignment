...
<div class="container report-box">
    <h4 class="text-center mb-4 text-primary">
        ...
        تقرير تقدم المشروع: <span class="text-dark"><?php echo htmlspecialchars($project['project_name']); ?></span>
    </h4>
    ...
    <div class="row text-center mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-box">
                <h5><i class="fa-solid fa-check-circle me-1"></i> مكتملة</h5>
            ...
            <tbody>
                <?php foreach ($tasks as $index => $task): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($task['username'] ?? 'غير معروف'); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
