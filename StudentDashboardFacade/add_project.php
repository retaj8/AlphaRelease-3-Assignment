...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $projectCode = isset($_POST['project_code']) ? trim($_POST['project_code']) : '';    $projectName = trim($_POST['project_name']);
    ...
    if ($project->isprojectExists($projectCode, $projectName)) {
        ...
        <div class="card p-4">
            ...
            <form method="post">
                <div class="mb-3">
                    ...
                    <input type="text" name="project_code" class="form-control" placeholder="أدخل معرف المشروع" required>
                </div>
                <div class="mb-3">
