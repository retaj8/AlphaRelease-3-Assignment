...
class Project {
    ...
    public function addProject($projectData, $teamMembers) {
        try {
            ...
            $sql = "INSERT INTO projects  (project_id, project_name, start_date, end_date, status, supervisor,team_leader)
                    VALUES (:project_id, :project_name, :start_date, :end_date, :status,  :supervisor,:team_leader)";
